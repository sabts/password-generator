  ...
  return (
    <main className={styles["container"]}>
      <div>
        <label>
          <input
            ...
            value={password}
            readOnly
            className={styles["input-text-type"]}
          />
        </label>
      </div>
      <div className={styles["range-container"]}>
        <label>
          ...
          <input
            ...
            max="32"
            value={rangeValue}
            onInput={e => showRangeValue(e, setRangeValue)}
      ...
      <div className={styles["toggle-option-box"]}>
        ...
        />
        <label htmlFor="uppercase" className={styles["label-checkbox"]}>
          {" "}
        </label>
      </div>
      ...
      <div className={styles["toggle-option-box"]}>
        ...
        <input
          ...
          className={styles["input-toggle"]}
        />
        <label htmlFor="lowercase" className={styles["label-checkbox"]}>
          {" "}
        </label>
      </div>
      ...
      <div className={styles["toggle-option-box"]}>
        ...
        <input
          ...
          className={styles["input-toggle"]}
        />
        <label htmlFor="numbers" className={styles["label-checkbox"]}>
          {" "}
        </label>
      </div>
      ...
      <div className={styles["toggle-option-box"]}>
        ...
        <input
          ...
          className={styles["input-toggle"]}
        />
        <label htmlFor="symbols" className={styles["label-checkbox"]}>
          {" "}
        </label>
      </div>

      <button
        onClick={() => passwordGenerator(allCheckboxs, rangeValue, setPassword)}
        disabled={!toggleCheekerActivateButton(allCheckboxs)}
...
const passwordGenerator = (allCheckboxs, rangeValue, setPassword) => {
  ...
  while (generatedPassword.length < rangeValue) {
    const randomChar =
      passwordAllowedChar[
        Math.floor(Math.random() * passwordAllowedChar.length)
      ];
    generatedPassword += randomChar;
  }
